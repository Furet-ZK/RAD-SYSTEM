<?php
  ...
  define('radman_dir', '/var/www/radiusmanager');		// radius manager full path
  ...
  define('baseurl', 'http://192.168.183.129/radiusmanager');	// base URL of RM system
  ...
  define('apperthread', 5);					// number of APs per thread in wlanpoller module (signal query)
  ...
  define('min_username_len', 1);				// minimal regular username length
  ...
  define('min_psw_len', 1);					// minimal regular password length
  define('max_psw_len', 32);					// maximal regular password length
  define('min_pswhsmac_len', 1);				// minimal Hotspot MAC password length
...
// unix executables
  ...
  define('SNMP_RETRIES', 2);					// SNMP retries
  ...
  define('confirmcitruspayment_tpl', 'confirmcitruspayment_tpl.htm');
