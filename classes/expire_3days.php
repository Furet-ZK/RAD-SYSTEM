...
$table = array(
    ...
    array('table'=>'rm_services', 'as'=>'jt1', 'join_type'=>'LEFT', 'join_on'=>'mt.srvid  = jt1.srvid'),
); 
...
$where = "mt.owner = '" . $_SESSION['AUTH_MANAGER'] . "' and date(mt.expiration) = curdate() + INTERVAL 3 DAY ";}

if ($_SESSION['AUTH_MANAGER'] == 'admin'){
$where = "date(mt.expiration) = curdate() + INTERVAL 3 DAY";}
